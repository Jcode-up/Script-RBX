...
-- Definir qual mundo o jogador está
...
-- Função para verificar a missão do jogador
function CheckQuest()
    ...
    -- Verifique outros mundos (World2, World3) de maneira similar...

    -- Exemplo para World2:
    if World2 then
        -- Defina as missões para o World2 baseado nos níveis do jogador
    end

    -- Similar para World3
    if World3 then
        -- Defina as missões para o World3 baseado nos níveis do jogador
    end
end
